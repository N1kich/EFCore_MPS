...
## Описание
Краткое описание и программная реализация проекта на тему "Разработка программного средства по управлению материально-производственными запасами (MPS) предприятия на основе метода Agile FDD"
